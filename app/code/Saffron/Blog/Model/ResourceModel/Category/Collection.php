...
namespace Saffron\Blog\Model\ResourceModel\Category;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        parent::_construct();
        $this->_init('Saffron\Blog\Model\Category', 'Saffron\Blog\Model\ResourceModel\Category');
    ...
    protected function _afterLoad()
    {
        ...
        if (count($items)) {
            ...
            $select = $connection->select()->from(['cps' => $this->getTable('saffron_blog_category_store')])
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                ['store_table' => $this->getTable('saffron_blog_category_store')],
