...
abstract class AbstractPost extends \Magento\Framework\View\Element\Template
{
     ...
     * @var string
     */
    protected $_defaultPostInfoBlock = 'Saffron\Blog\Block\Post\Info';

    /**
     * @var string
     */
    //protected $_defaultPostCommentsBlock = 'Saffron\Blog\Block\Post\View\Comments';
    ...
    public function __construct(
        ...
        \Saffron\Blog\Model\Post $post,
        \Magento\Framework\Registry $coreRegistry,
        \Magento\Cms\Model\Template\FilterProvider $filterProvider,
        \Saffron\Blog\Model\PostFactory $postFactory,
        array $data = []
    ) {
     ...
     *
     * @return \Saffron\Blog\Model\Post
     */
     ...
     *
     * @return \Saffron\Blog\Block\Post\Info
     */
