...
namespace Saffron\Blog\Block\Adminhtml\Category\Edit\Tab;
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var $model \Saffron\Blog\Model\Category */
        $model = $this->_coreRegistry->registry('current_model');

        /*
         * Checking if user have permissions to save information
         */
        $isElementDisabled = !$this->_isAllowedAction('Saffron_Blog::category');
        ...
        $this->_eventManager->dispatch('Saffron_blog_category_edit_tab_content_prepare_form', ['form' => $form]);
