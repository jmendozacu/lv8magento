...
namespace Saffron\Blog\Block\Adminhtml\Post\Edit\Tab;
...
class Meta extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
         ...
         */
        $isElementDisabled = !$this->_isAllowedAction('Saffron_Blog::post');
        ...
        $this->_eventManager->dispatch('Saffron_blog_post_edit_tab_meta_prepare_form', ['form' => $form]);
