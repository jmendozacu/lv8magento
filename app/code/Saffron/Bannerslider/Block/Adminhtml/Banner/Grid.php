...
namespace Saffron\Bannerslider\Block\Adminhtml\Banner;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended {
	...
	protected function _prepareColumns() {
		...
		$this->addColumn(
			...
			[
				...
				'width' => '50px',
				'filter' => false,
				'renderer' => 'Saffron\Bannerslider\Block\Adminhtml\Banner\Helper\Renderer\Image',
			]
		);
		$this->addColumn(
			'click_url',
  ...
  static public function getCategoriesAction()
		{
		$catId =2;
		...
		$objectManager = \Magento\Framework\App\ObjectManager::getInstance();
        $subcategory = $objectManager->create('Magento\Catalog\Model\Category')->load($subcat['entity_id']);   
        if($subcat->getIsActive()) :
        if($subcategory['include_in_menu']==1) : 
        
		$data_array[$subcat->getId()]=$subcat->getName();
		endif ;
        endif ;		
